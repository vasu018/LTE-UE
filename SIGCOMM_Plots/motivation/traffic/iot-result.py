    ...
    for item_x1, line in enumerate(ins):
        ...
        if item_x1 < 100000: 
            ...
            if float(x1) >= 50.0:
                ...
                #x1 = random.random()
            elif float(x1) > 4.0 and float(x1) < 50.0:
                ran_int = random.randint(2,3)
                x1 = ran_int * random.random()
                #x1 = random.random()
...
data1_control_bin = ax1.plot(data_x, data1_control_bin, linewidth=2, linestyle='-', color='green', label='Motion Sensors')
data2_control_bin = ax1.plot(data_x, data2_control_bin, linewidth=2, linestyle='-', color='salmon', label='Drop Cam')
