...
ax2 = ax.twinx() 
fig.subplots_adjust(left=0.1, bottom=0.1, right=0.90)
...
pivot_df.plot.bar(stacked=True,ax=ax,
                       colormap=ListedColormap(sns.color_palette("GnBu_d")),
                        ylim=[0, 300000],
                       rot=30,error_kw=dict(elinewidth=2,ecolor='k'), linewidth=2, width=width, capsize=10, position=0, fontsize='24')

ax.set_xticklabels(['12am - 4am', '4am - 8am', '8am - 12pm','12pm - 4pm', '4pm - 8pm', '8pm - 12am'],fontsize = '24',rotation ='0')
...
ax2.set_ylabel('Normalized Data Load', fontsize='42')
...
pivot_df.plot.bar(stacked=True, ax=ax2,
                       colormap=ListedColormap(sns.color_palette("GnBu_d")),
                       rot=30, ylim=[0, 50000], error_kw=dict(elinewidth=2,ecolor='k'), linewidth=2, width=width, capsize=10, position =1, fontsize='24')
ax.set_xticklabels(['12am - 4am', '4am - 8am', '8am - 12pm',  '12pm - 4pm', '4pm - 8pm', '8pm - 12am'],fontsize = '24',rotation ='0')
