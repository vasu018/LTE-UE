...
rects1 = ax1.bar(ind+0.1, s2, width, color='gold', error_kw=dict(elinewidth=2,ecolor='sandybrown'), linewidth=4, capsize=10, label='50% Skew', hatch='/')
rects2 = ax1.bar(ind+width+0.15, s1, width, color='tomato', error_kw=dict(elinewidth=2,ecolor='sandybrown'), linewidth=4, capsize=10, label='Without Skew', hatch='.')
