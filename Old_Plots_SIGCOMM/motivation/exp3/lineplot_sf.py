...
plt.scatter(data1, data2, marker='d', s=256, color='g', label='Background Control')
plt.scatter(data3, data4, marker='o', facecolors='none', s=256, color='r', label='Restore and Attach')
