...
p = open('data2/attach_10000_1_1us_delay.txt', 'r')
for i in p:
	i = i.strip().split(',')
	attach_alone = [float(j) for j in i]
p = open('data2/service_10000_1_1us_delay.txt', 'r')
for i in p:
        i = i.strip().split(',')
        service_alone = [float(j) for j in i]
p = open('data2/attach_5000_1.txt', 'r')
for i in p:
	i = i.strip().split(',')
        print i
	attach = [float(j) for j in i]
p = open('data2/service_5000_1.txt', 'r')
for i in p:
        i = i.strip().split(',')
